 ...
 *
 * @author miquel
 *      Pila per a números positius.
 *      Aquesta programa és una implantació d'una pila per a números positius. 
 *      Només permet la inserció (apilar) valors superiors a 0 (no es considera el 0 com a valor positiu
 * 
